...
const HOME_TEXT: Record<string, Strings> = {
  ...
  ru: {
    ...
    lede: 'Выделите незнакомое слово в субтитрах, на странице или в PDF. Оно переведётся в том значении, в котором используется в этой фразе, и останется в вашей библиотеке.',
  ...
  et: {
    ...
    lede: 'Vali tundmatu sõna subtiitrist, lehelt või PDF-ist. See tõlgitakse selles lauses kasutatud tähenduses ja jääb sinu kogusse.',
  ...
  fr: {
    ...
    lede: 'Sélectionnez un mot inconnu dans un sous-titre, sur une page ou dans un PDF. Il est traduit dans le sens qu\'il a dans cette phrase et reste dans votre bibliothèque.',
  ...
  es: {
    ...
    lede: 'Selecciona una palabra desconocida en un subtítulo, en una página o en un PDF. Se traduce en el sentido que tiene en esa frase y se queda en tu biblioteca.',
  ...
  it: {
    ...
    lede: 'Seleziona una parola sconosciuta in un sottotitolo, su una pagina o in un PDF. Viene tradotta nel senso che ha in quella frase e resta nella tua raccolta.',
  ...
  pt: {
    ...
    lede: 'Selecione uma palavra desconhecida numa legenda, numa página ou num PDF. É traduzida no sentido que tem nessa frase e fica na sua biblioteca.',
  ...
  uk: {
    ...
    lede: 'Виділіть незнайоме слово в субтитрі, на сторінці або в PDF. Воно перекладеться в тому значенні, яке має в цій фразі, і лишиться у вашій бібліотеці.',
